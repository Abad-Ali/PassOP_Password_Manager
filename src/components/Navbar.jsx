      ...
      <nav className='bg-gray-950 flex justify-between items-center p-1 h-12 text-white '>
        ...
        <ul>
            <li className='flex md:gap-5 md:mr-22  md:ml-0 text-xs md:text-base'>
              ...
              <a className='hover:text-blue-700 text-2xs md:text-xl ml-2' href='https://github.com/Abad-Ali/PassOP_Password_Manager/blob/main/README.md' target="_blank">About</a>
              <a className='hover:text-blue-700 text-2xs md:text-xl ml-2 md:mr-7' href='https://github.com/Abad-Ali' target="_blank">Contact</a>
            </li>
        </ul>
