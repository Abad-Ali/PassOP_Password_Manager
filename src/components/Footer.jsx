...
const Footer = () => {
  return (
    <div className='bg-gray-950 text-gray-500 p-8'>
      <div className='flex justify-center text-xs md:text-base'>Thanks for visiting! | Customer Support: [<a className="hover:text-blue-700" href="https://github.com/Abad-Ali" target="_blank">GitHub</a>] </div>
